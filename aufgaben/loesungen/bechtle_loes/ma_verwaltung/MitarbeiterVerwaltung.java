...
public class MitarbeiterVerwaltung {
	...
	private ArrayList<Mitarbeiter> mlist;
	...
	public MitarbeiterVerwaltung() {
		...
		//Füllschleife: 100 Mitarbeiter erzeugen und einf�llen
		...
		for (int i = 0; i < marray.length; ++i) {
			if (i%2 == 0) {
				...
				Project p = new Project(LocalDate.now(), 30_000, i);
				m = new MitarbeiterMitProjekt("Erika", "Maulwurf" + i,
						  LocalDate.of(1976, 1 + (int)(Math.random()*12), 1), 
						  LocalDate.of(2000,1, 1), 
						  new BigDecimal((int)(Math.random()*10000)),
						  Geschlecht.W,
	...
	public ArrayList<Mitarbeiter> getMlist() {
		return mlist;
	}
