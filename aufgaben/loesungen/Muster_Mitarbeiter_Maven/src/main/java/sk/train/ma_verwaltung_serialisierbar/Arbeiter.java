...
public class Arbeiter extends Mitarbeiter {
	...
	public String toString() {
		return "Arbeiter [stdlohn=" + stdlohn + ", stdzahl=" + stdzahl + ", getVorname()=" + getVorname()
				+ ", getGeschlecht()=" + getGeschlecht() + ", getNachname()=" + getNachname() + ", getPersnr()="
				+ getPersnr() + ", getGebdatum()=" + getGebdatum() + ", getEinstdatum()=" + getEinstdatum()				
				+ "]";
	}
