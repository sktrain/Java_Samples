...
public class Mitarbeiter {
	...
	private Abteilung abt;  //null als default, sofern der Mitarbeiter keiner Abteilung angehören muss
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((abt == null) ? 0 : abt.hashCode());
	...
	public String toString() {
		return "Mitarbeiter [persnr=" + persnr + ", vorname=" + vorname + ", nachname=" + nachname + ", gebdatum="
				+ gebdatum + ", einstdatum=" + einstdatum + ", gehalt=" + gehalt + ", abt=" + abt + ", ges=" + ges
				+ "]";
	}
