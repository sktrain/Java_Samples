package sk.train.ma_verwaltung_strategy_serializable;
...
public class MItarbeiterVerwaltungTest {
	...
	public static void main(String[] args) {
		...
		List<Mitarbeiter> mlist1 = mv.getMlist(Comparator.naturalOrder());
		...
		List<Mitarbeiter> mlist2 = mv.getMlist(Comparator.naturalOrder());
